...
<strong>Email:</strong> <a href="mailto:onpet@yoursite.com">onpet@yoursite.com</a>
</p>
</div>
...
<a class="navbar-brand" href="{{ url('/index')}}"><img height="60 px" width="160 px" src="{{ URL::asset('petvet/images/onpetlogo.png') }}" alt="Ova"></a>
<div>
...
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Features <span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    <li><a href="{{ url('/products') }}">Pet Shop</a></li>
    <li><a href="{{ url('/cares') }}">Pet Care</a></li>
    <li><a href="{{ url('/pets') }}">Pet Purchase</a></li>
    <li><a href="{{ url('/vets') }}">Vet Consultation</a></li>
  </ul>
</li>
<li class="dropdown has-submenu">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Orders <span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    <li><a href="{{ url('/customer/order/product') }}">Products</a></li>
    <li><a href="{{ url('/customer/order/care') }}">Cares</a></li>
    <li><a href="{{ url('/customer/order/pet') }}">Pets</a></li>
    <li><a href="{{ url('/customer/order/vet') }}">Vets</a></li>
  </ul>
</li>
@endif

@if(Session::get('type-petshop') == 'petshop')
<li><a href="{{ url('/dashboard') }}">Dashboard</a></li>
<li class="dropdown has-submenu">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Things <span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    <li><a href="{{ url('/petshop/products') }}">Products</a></li>
    <li><a href="{{ url('/petshop/cares') }}">Cares</a></li>
    <li><a href="{{ url('/petshop/pets') }}">Pets</a></li>
    <li><a href="{{ url('/petshop/vets') }}">Vets</a></li>
  </ul>
</li>
<li class="dropdown has-submenu">
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Orders <span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    <li><a href="{{ url('/petshop/order/product') }}">Products</a></li>
    <li><a href="{{ url('/petshop/order/care') }}">Cares</a></li>
    <li><a href="{{ url('/petshop/order/pet') }}">Pets</a></li>
    <li><a href="{{ url('/petshop/order/vet') }}">Vets</a></li>
  </ul>
</li>
@endif
...
@if(Session::get('type-petshop') == 'petshop')
<li class="dropdown has-submenu">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><strong>{{Session::get('type-petshop-name')}}</strong><span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    <li><a href="{{ url('/petshop/profile') }}">Profile</a></li>
    <li><a href="{{ route('logout_petshop') }}">Logout</a></li>
  </ul>
</li>
@elseif(Session::get('type-customer') == 'customer') 
<li class="dropdown has-submenu">
  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><strong>{{Session::get('type-customer-name')}}</strong><span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
...
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Account<span class="fa fa-angle-down"></span></a>
  <ul class="dropdown-menu start-left" role="menu">
    ...
    <li><a href="{{ url('/petshop/login') }}">Petshop Login</a></li>
    <li><a href="{{ url('/petshop/register') }}">Petshop Register</a></li>
  </ul>
</li>
@endif
...
<img height="100" width="250" style="background-color:white;border-radius:50px;margin-left:50px" src="{{ URL::asset('petvet/images/onpetlogo.png') }}" alt="" class="img-responsive">
<p>We accomodate you for fullfilling your needs on pet</p>
<div class="social">
<a href="#" data-tooltip="tooltip" data-placement="bottom" title="Facebook"><i class="fa fa-facebook"></i></a>
<a href="#" data-tooltip="tooltip" data-placement="bottom" title="Twitter"><i class="fa fa-twitter"></i></a>
<a href="#" data-tooltip="tooltip" data-placement="bottom" title="Pinterest"><i class="fa fa-pinterest"></i></a>
...
<ul>
<li><i class="fa fa-link"></i> www.onpet.com</li>
<li><i class="fa fa-envelope"></i> onpet@yoursite.com</li>
<li><i class="fa fa-phone"></i> +6282108210821</li>
<li><i class="fa fa-fax"></i> +6256998</li>
