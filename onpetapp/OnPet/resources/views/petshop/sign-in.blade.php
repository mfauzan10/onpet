...
<form method="POST" action="{{ route('login_petshop') }}">
@csrf
<header class="form-header">
    <h3>Petshop Login Form</h3>
</header>
...
<div class="col-md-12">
<button type="submit"  class="btn btn-primary btn-block btn-lg align-center">Login</button>
</div>
