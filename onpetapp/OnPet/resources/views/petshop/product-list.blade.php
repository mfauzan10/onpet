...
<div class="row">
    <button type="button" class="col-lg-12 btn btn-warning btn-lg" data-toggle="modal" data-target="#myModal"><strong>Add</strong></button>
</div>
<div id="myModal" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="{{route('add_product_petshop')}}" enctype="multipart/form-data">
            {{ csrf_field() }}
...
<section class="container section">
    ...
    @foreach($products as $product)
        <div class="col-md-3 grid cs-style-3" style="border-">
            ...
            <h4><p class="card-text">{{$product->name}}</p></h4>
